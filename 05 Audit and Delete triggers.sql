...
BEGIN TRY
  ...
  begin
    insert into Change_History select b.Group_ID, b.Customer_ID, 'Group_ID', b.Customer_ID, 'Group_ID', null, Group_ID, 'Int32', a.Datetime_Of_Action, a.Username from inserted a inner join Customer b on a.Customer_ID = b.Customer_ID
